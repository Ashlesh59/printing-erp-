...
contextBridge.exposeInMainWorld('api', {
  ...
  submitOrder: (data) => ipcRenderer.invoke('orders:submit', data),
  cancelOrder: (orderId, reason) => ipcRenderer.invoke('orders:cancel', { orderId, reason }),
  retryPrint: (orderId, options) => ipcRenderer.invoke('orders:retry-print', { orderId, options }),
  recordPayment: (data) => ipcRenderer.invoke('orders:record-payment', data),
  calculatePricing: (items, options) => ipcRenderer.invoke('orders:calculate-pricing', { items, options }),
  createOrder: (data) => ipcRenderer.invoke('orders:submit', data),
  ...
  getInvPurchaseOrders: (filters) => ipcRenderer.invoke('get-inv-purchase-orders', filters),
  ...
  approveInvPurchaseOrder: (poId, data) => ipcRenderer.invoke('approve-inv-purchase-order', { poId, data }),
  markInvPurchaseOrderOrdered: (poId, data) => ipcRenderer.invoke('mark-inv-purchase-order-ordered', { poId, data }),
  ...
  getInvGoodsReceipts: (poId) => ipcRenderer.invoke('get-inv-goods-receipts', poId),
  getInvSupplierBills: (supplierId) => ipcRenderer.invoke('get-inv-supplier-bills', supplierId),
  createInvSupplierBill: (data) => ipcRenderer.invoke('create-inv-supplier-bill', data),
  getInvSupplierPayments: (supplierId) => ipcRenderer.invoke('get-inv-supplier-payments', supplierId),
  recordInvSupplierPayment: (data) => ipcRenderer.invoke('record-inv-supplier-payment', data),
  reverseInvSupplierPayment: (paymentId, data) => ipcRenderer.invoke('reverse-inv-supplier-payment', { paymentId, data }),
  getInvPurchaseReturns: (supplierId) => ipcRenderer.invoke('get-inv-purchase-returns', supplierId),
  getInvSupplierStatement: (supplierId) => ipcRenderer.invoke('get-inv-supplier-statement', supplierId),
  getInvPurchasingIntegrityReport: () => ipcRenderer.invoke('get-inv-purchasing-integrity-report'),

  // Direct Purchasing Service namespace
  purchasing: {
    getOrders: (filters) => ipcRenderer.invoke('purchasing:get-orders', filters),
    getOrder: (id) => ipcRenderer.invoke('purchasing:get-order', id),
    createOrder: (data) => ipcRenderer.invoke('purchasing:create-order', data),
    approveOrder: (poId) => ipcRenderer.invoke('purchasing:approve-order', poId),
    markOrdered: (poId) => ipcRenderer.invoke('purchasing:mark-ordered', poId),
    receiveItems: (data) => ipcRenderer.invoke('purchasing:receive-items', data),
    getReceipts: (poId) => ipcRenderer.invoke('purchasing:get-receipts', poId),
    getBills: (supplierId) => ipcRenderer.invoke('purchasing:get-bills', supplierId),
    createBill: (data) => ipcRenderer.invoke('purchasing:create-bill', data),
    getPayments: (supplierId) => ipcRenderer.invoke('purchasing:get-payments', supplierId),
    recordPayment: (data) => ipcRenderer.invoke('purchasing:record-payment', data),
    reversePayment: (paymentId, reason) => ipcRenderer.invoke('purchasing:reverse-payment', { paymentId, reason }),
    getReturns: (supplierId) => ipcRenderer.invoke('purchasing:get-returns', supplierId),
    createReturn: (data) => ipcRenderer.invoke('purchasing:create-return', data),
    cancelOrder: (poId, reason) => ipcRenderer.invoke('purchasing:cancel-order', { poId, reason }),
    getSupplierStatement: (supplierId) => ipcRenderer.invoke('purchasing:get-supplier-statement', supplierId),
    getIntegrityReport: () => ipcRenderer.invoke('purchasing:get-integrity-report')
  },
